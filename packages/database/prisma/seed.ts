/**
 * Development seed data — clearly demo-only.
 * Creates: demo user/workspace, plan catalog, an active subscription,
 * one connected marketplace account per platform, products with historical
 * costs, ~30 days of orders, ad spend and pre-aggregated daily metrics.
 *
